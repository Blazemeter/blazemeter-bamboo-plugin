...
public class BambooCiPostProcess extends CiPostProcess{
    // TODO to api-client 1.3
    public BambooCiPostProcess(boolean isDownloadJtl, boolean isDownloadJunit, String jtlPath, String junitPath, String workspaceDir, UserNotifier notifier, Logger logger) {
